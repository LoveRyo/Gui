do  local ui =  game.Players.LocalPlayer.PlayerGui:FindFirstChild("Gold-Lib")  if ui then ui:Destroy() end end
...
local GoldLib = Instance.new("ScreenGui")
...
local Properties = {
	...
	Shadow = {
		Name = "Shadow",
		BackgroundTransparency = 1,
		Image = "http://www.roblox.com/asset/?id=5554234805",
		ScaleType = Enum.ScaleType.Slice,
...
GoldLib.Name = "Gold-Lib"
GoldLib.Parent = game.Players.LocalPlayer.PlayerGui
GoldLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
function lib:main()
	...
	HomeButton.Image = "rbxassetid://6248942117" --11940135535
	...
	Main.ClipsDescendants = true
	TweenService:Create(Main,TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{Size = UDim2.new(0, 1041, 0, 530)}):Play() 
	...
	ImageLabel.Image = "http://www.roblox.com/asset/?id=6248942117"
	...
	Page.Size = UDim2.new(0, 1000, 0, 758)
	...
	UserInputService.InputBegan:Connect(function(input)
		if input.KeyCode == Enum.KeyCode.RightControl then
			if uihide == false then
				...
				uihide = false
				pcall(Main:TweenSize(UDim2.new(0, 1041, 0, 530),"Out","Back",0.4,true)) wait()
	...
	function tabs:Tab(options)
		...
		IconTab.Size = UDim2.new(0, 35, 0, 35)
		...
		PageMain.Size = UDim2.new(0, 1000, 0, 758)
		...
		ScrollingPage.Size = UDim2.new(0, 1000, 0, 758)
		...
		Pageleft.Size = UDim2.new(0, 493, 0, 755)
		...
		Pageright.Size = UDim2.new(0, 493, 0, 755)
		...
		game:GetService("RunService").Stepped:Connect(function()
			if UIListLayoutPageleft.AbsoluteContentSize.Y > UIListLayoutPageright.AbsoluteContentSize.Y then
				ScrollingPage.CanvasSize = UDim2.new(0, 0, 0, UIListLayoutPageleft.AbsoluteContentSize.Y + 300)
			end
		end)
		game:GetService("RunService").Stepped:Connect(function()
			if UIListLayoutPageright.AbsoluteContentSize.Y > UIListLayoutPageleft.AbsoluteContentSize.Y then
				ScrollingPage.CanvasSize = UDim2.new(0, 0, 0, UIListLayoutPageright.AbsoluteContentSize.Y + 300)
			end
		end)

		game:GetService("RunService").Stepped:Connect(function()
			Pageleft.Size = UDim2.new(0, 493, 0, UIListLayoutPageleft.AbsoluteContentSize.Y + 5)
		end)
		game:GetService("RunService").Stepped:Connect(function()
			Pageright.Size = UDim2.new(0, 493, 0, UIListLayoutPageright.AbsoluteContentSize.Y + 5)
		end)
		...
		function LibraryPage:Page(type)
			...
			Container_Page.Size = UDim2.new(0, 480, 0, 736)
			...
			game:GetService("RunService").Stepped:Connect(function()
				Container_Page.Size =  UDim2.new(0, 480, 0,UIListLayoutContainer_Page.AbsoluteContentSize.Y + 35)
			end)
			local libitem = {}
			function libitem:Button(title,des,logo,callback)
				...
				ButtonFrame.Size = UDim2.new(0, 445, 0, 169)
				...
				imgbutton.Image = "rbxassetid://6248942117" -- change

				Button.Name = "Button"
				Button.Parent = ButtonFrame
				Button.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				Button.BackgroundTransparency = 1.000
				Button.Position = UDim2.new(0.0217054263, 0, 0.65480474, 0)
			...
			function libitem:Dropdown(text,item,default,callback)
				...
				DropFrame.Size = UDim2.new(0, 445, 0, 110)
				...
				Drop.Size = UDim2.new(0, 404, 0, 49)
				...
				DropButton.Size = UDim2.new(0, 404, 0, 49)
				...
				DownFrame.Size = UDim2.new(0, 404, 0, 203)
				...
				ScrollingDown.Size = UDim2.new(0, 400, 0, 203)
				...
				for i,v in pairs(item) do
					...
					ItemFrame.Size = UDim2.new(0, 375, 0, 52)
					...
					HanderItem.Size = UDim2.new(0, 375, 0, 52)
					...
					ItemButton.Size = UDim2.new(0, 375, 0, 52)
			...
			function libitem:Slider(text,floor,min,max,de,callback)
				...
				SliderFrame.Size = UDim2.new(0, 445, 0, 139)
				...
				CustomValue.Position = UDim2.new(0.689147317, 0, 0.107913673, 0)
				...
				ValueFrame.Size = UDim2.new(0, 388, 0, 26)
				...
				PartValue.Size = UDim2.new(0, 388, 0, 26)
			...
			function libitem:Toggle(titel,des,icon,default,callback)
				...
				ToggleFrame.Size = UDim2.new(0, 445, 0, 169)
				...
				IconToggle.Size = UDim2.new(0, 100, 0, 100)
				...
				Toggle.BackgroundColor3 = Color3.fromRGB(83, 83, 83)
				...
				ToggleIner.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				...
				TextButtonToggle.Size = UDim2.new(0, 445, 0, 169)
				...
				LockerFrame.Size = UDim2.new(0, 445, 0, 169)
